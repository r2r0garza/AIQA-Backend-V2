...
from supabase_client import get_template_for_agent, debug_list_document_types, get_document_texts_by_type
...
async def agent_handler(
  ...
  try:
    ...
    # print("[AI Debug] Payload sent to analyze_expert:", analyze_payload)
